...
folder_ori=x0-8p527mm
folder_dst=x0-8p527mm-reftraj

function create_pos {
  current=$1
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-002/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-003/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-004/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-005/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-006/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-009/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-010/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-011/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-012/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-013/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-014/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-015/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-016/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-017/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-018/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-019/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-020/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-021/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-022/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-023/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-024/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-025/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-026/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-027/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-028/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-029/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-030/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-031/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-032/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-033/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-034/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-035/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-036/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-037/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-038/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-039/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-040/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-041/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-042/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-043/$current/z-positive/
  cp ./$folder_ori/trajectory-b1-pos.in ./$folder_dst/B1-046/$current/z-positive/
}

function create_neg {
  current=$1
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-002/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-003/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-004/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-005/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-006/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-009/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-010/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-011/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-012/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-013/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-014/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-015/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-016/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-017/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-018/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-019/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-020/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-021/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-022/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-023/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-024/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-025/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-026/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-027/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-028/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-029/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-030/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-031/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-032/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-033/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-034/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-035/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-036/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-037/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-038/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-039/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-040/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-041/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-042/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-043/$current/z-negative/
  cp ./$folder_ori/trajectory-b1-neg.in ./$folder_dst/B1-046/$current/z-negative/
}
